...
from models.fpn.model import fpn_graph
from models.rpn.model import RPN
...
def mrcnn(config):
    ...
    P2, P3, P4, P5, P6 = fpn_graph(input_tensor=input_image, backbone=config.BACKBONE, extended_layer='P6')
    ...
    # RPN Model
    rpn = RPN(config.RPN_ANCHOR_STRIDE, len(config.RPN_ANCHOR_RATIOS), config.TOP_DOWN_PYRAMID_SIZE)
    ...
    #     model = ParallelModel(model, cfg.GPU_COUNT)
